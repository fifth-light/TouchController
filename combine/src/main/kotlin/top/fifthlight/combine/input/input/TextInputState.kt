...
data class TextInputState(
    ...
    fun commitText(commitText: String): TextInputState {
        return if (composition.length == 0) {
    ...
    fun doBackspace(): TextInputState {
        return if (composition.length != 0) {
    ...
    fun doArrowLeft(): TextInputState {
        return if (composition.length != 0) {
            // IME should handle this, not by us
            return this
        } else if (selection.length > 0) {
    ...
    fun doArrowRight(): TextInputState {
        return if (composition.length != 0) {
            // IME should handle this, not by us
            return this
        } else if (selection.length > 0) {
    ...
    fun doShiftLeft(): TextInputState {
        return if (composition.length != 0) {
            // IME should handle this, not by us
            return this
        } else if (selection.length == 0) {
    ...
    fun doShiftRight(): TextInputState {
        return if (composition.length != 0) {
            // IME should handle this, not by us
            return this
        } else if (selection.length == 0) {
