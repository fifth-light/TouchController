...
data class ScreenshotButton(
    ...
    companion object : KoinComponent {
        ...
        private val _properties = baseProperties + persistentListOf<Property<ScreenshotButton, *>>(
            FloatProperty(
                getValue = { it.size },
                ...
                messageFormatter = {
                    textFactory.format(
                        Texts.SCREEN_OPTIONS_WIDGET_SCREENSHOT_BUTTON_PROPERTY_SIZE,
            ...
            BooleanProperty(
                ...
                message = textFactory.of(Texts.SCREEN_OPTIONS_WIDGET_SCREENSHOT_BUTTON_PROPERTY_CLASSIC),
            )
