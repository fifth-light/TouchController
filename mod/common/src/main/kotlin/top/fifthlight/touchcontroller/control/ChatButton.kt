...
data class ChatButton(
    ...
    companion object : KoinComponent {
        ...
        private val _properties = baseProperties + persistentListOf<Property<ChatButton, *>>(
            FloatProperty(
                getValue = { it.size },
            ...
            BooleanProperty(
                ...
                message = textFactory.of(Texts.SCREEN_OPTIONS_WIDGET_CHAT_BUTTON_PROPERTY_CLASSIC),
            )
        )
    }
