...
val languageFile = File(projectDir, "src/main/resources/assets/touchcontroller/lang/en_us.json")
...
val textureDir = File(projectDir, "src/main/resources/assets/touchcontroller/textures")
